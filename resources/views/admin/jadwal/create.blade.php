                ...
                <form action="{{ route('admin.jadwal.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                    ...
                                    <select class="form-control @error('anak_id') is-invalid @enderror" name="anak_id"
                                        ...
                                        @foreach ($anakList as $anak)
                                            <option value="{{ $anak->id }}"
                                                {{ old('anak_id') == $anak->id ? 'selected' : '' }}>{{ $anak->nama }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('drivers_id') is-invalid @enderror" name="drivers_id"
                                        required>
                                        <option value="">Pilih Pengemudi</option>
                                        @foreach ($driverList as $driver)
                                            <option value="{{ $driver->id }}"
                                                {{ old('drivers_id') == $driver->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('jam_antar') is-invalid @enderror"
                                        name="jam_antar" value="{{ old('jam_antar') }}" required>
                                    @error('jam_antar')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('jam_jemput') is-invalid @enderror"
                                        name="jam_jemput" value="{{ old('jam_jemput') }}" required>
                                    @error('jam_jemput')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('lokasi_antar') is-invalid @enderror" rows="2" name="lokasi_antar"
                                placeholder="Contoh: Jl. Sudirman No. 123">{{ old('lokasi_antar') }}</textarea>
                            @error('lokasi_antar')
                                <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('lokasi_jemput') is-invalid @enderror" rows="2" name="lokasi_jemput"
                                placeholder="Contoh: Sekolah Pelita Harapan">{{ old('lokasi_jemput') }}</textarea>
                            @error('lokasi_jemput')
                                <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('catatan') is-invalid @enderror" rows="3" name="catatan"
                                placeholder="Catatan tambahan untuk pengemudi">{{ old('catatan') }}</textarea>
                            @error('catatan')
                                <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
